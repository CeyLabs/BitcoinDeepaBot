...
func (bot TipBot) getHandler() []InterceptionWrapper {
	return []InterceptionWrapper{
		...
		{
			Endpoints: []interface{}{"/so"},
			Handler:   bot.soHandler,
			Interceptor: &Interceptor{
				Before: []intercept.Func{
					bot.requirePrivateChatInterceptor,
					bot.localizerInterceptor,
		...
		{
			Endpoints: []interface{}{"/lkrsats", &btnConvertMainMenu},
			Handler:   bot.lkrToSatHandler,
			Interceptor: &Interceptor{
				Before: []intercept.Func{
					bot.requirePrivateChatInterceptor,
					bot.localizerInterceptor,
		...
		{
			Endpoints: []interface{}{"/convert"},
			Handler:   bot.satToFiatHandler,
			Interceptor: &Interceptor{
				Before: []intercept.Func{
					bot.requirePrivateChatInterceptor,
					bot.localizerInterceptor,
		...
		{
			Endpoints: []interface{}{&btnCancelAPITx},
			Handler:   bot.cancelAPITransactionHandler,
			Interceptor: &Interceptor{
